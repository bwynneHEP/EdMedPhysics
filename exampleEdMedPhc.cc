...
// ********************************************************************
//
// $Id: exampleEdMedPhc.cc 100946 2016-11-03 11:28:08Z gcosmo $
//
/// \file exampleEdMedPhc.cc
/// \brief Main program of the EdMedPhc example
...
namespace {
  void PrintUsage() {
    G4cerr << " Usage: " << G4endl;
    G4cerr << " exampleEdMedPhc [-m macro ] [-u UIsession] [-t nThreads]" << G4endl;
...
int main(int argc,char** argv)
{
  ...
  //
  auto detConstruction = new EdMedPhcDetectorConstruction();
